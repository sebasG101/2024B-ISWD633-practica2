...
```
```
docker exec srv-jenkins ls -lap
```

### ¿Para qué se usa el comando ls?
Muestra los archivos y subdirectorios que se encuentran en el directorio actual o en un directorio especificado.
### ¿Para qué sirve el argumento -l junto al comando ls?
El argumento -l, muestra información detallada como los permisos, propietario, grupo, tamaño, y fecha de modificación de los archivos o directorios.
